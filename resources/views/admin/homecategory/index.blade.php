...
@section('page_title','Home Categorys')
@section('content')
<!-- users list start -->
<section class="app-user-list">
    ...
    <div class="card">
        ...
        <div class="card-header border-bottom d-flex justify-content-between align-items-center">
          <h4 class="card-title">Home Categorys</h4>
          <a href="{{ route('homecategorys.create') }}"><button type="reset" class="btn btn-primary mr-1 waves-effect waves-float waves-light">Add New Category</button></a>
        </div>
...
<script type="text/javascript">
    $(function() {
        var table = $('.user-list-table').DataTable({
            ...
            searching: true,
            order: [[1, 'desc']],
            ajax: "{{ route('homecategorys.index') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'id',
                    orderable: false,
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                    type:'POST',
                    url:"{{route('change-homecategory-status')}}",
                    dataType:'json',
