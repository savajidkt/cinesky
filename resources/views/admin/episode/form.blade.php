<div class="row">
    <div class="col-12">
        <div class="form-group">
            <label class="form-label" for="basic-default-email1">Series</label>
    ...
    <div class="col-12">
        <div class="form-group">
            <label class="form-label" for="basic-default-email1">Seasons</label>
            <select name="season_id" class="form-control" id="season_id">
                <option value="">Select Season</option>
                @if ($lists->count())
                @foreach ($lists as $list)

                @php
                if(isset($model->season_id) && $model->season_id == $list->id){
                $selectedCom ='selected';
                }else{
                $selectedCom = $list->id == old('season_id') ? 'selected' : '';
                }
                @endphp
                <option value="{{ $list->id }}" {{ $selectedCom }}> {{ $list->season_name }}</option>
                @endforeach
                @endif
              </select>
            <div class="valid-feedback">Looks good!</div>
