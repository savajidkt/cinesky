...
<section class="app-user-list">
    ...
    <div class="card">
        ...
        <div class="card-header border-bottom d-flex justify-content-between align-items-center">
          ...
          <a href="{{ route('tvepisodes.create') }}"><button type="reset" class="btn btn-primary mr-1 waves-effect waves-float waves-light">Add New Episode</button></a>
        </div>
        ...
        var table = $('.user-list-table').DataTable({
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                    type:'POST',
                    url:"{{route('change-tvepisode-status')}}",
                    dataType:'json',
